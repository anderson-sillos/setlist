...
- As mudanças de rota não usarão animação automática. A animação horizontal será mantida na abertura e no fechamento do menu lateral móvel, preservando os gestos de navegação já definidos.
