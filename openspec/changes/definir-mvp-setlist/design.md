...
- No celular e no tablet em modo retrato, a navegação frequente da banda usará uma barra inferior fixa e compacta com Shows, Repertório, Palco e Banda, com pequena margem nas laterais, ícones legíveis e destinos distribuídos proporcionalmente. Palco abrirá uma seleção de shows antes da experiência de execução. Um menu lateral reunirá identificação do usuário, acesso a `Minhas bandas`, perfil e conta, termos gerais e privacidade, informações sobre o Setlist e saída.
